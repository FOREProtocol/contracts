...
(() => {
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      function Ye(t, e, n) {
        (ze = t), ce(e, n || {}, We, Ze, Xe, t), (ze = void 0);
      }
      var Qe = null;
      function tn(t) {
        var e = Qe;
      ...
      function mr(t, n) {
        ...
        if (
          ...
          for (i in ((W || X) && u.value !== c.value && yr(s, "value", u.value),
          c))
            e(u[i]) &&
              (Hn(i)
          ...
          if ("select" === n.tag) {
            ...
            o.some(function (t, e) {
              ...
              (t.multiple
                ...
                : e.value !== e.oldValue && Wo(e.value, o)) &&
              Qo(t, "change");
          }
        },
      };
              ...
              if (((r = o = u[e].name), (i = u[e].value), Yi.test(r)))
                if (
                  ...
                  (r = r.replace(oa, "")),
                    ...
                    (a && a.prop) ||
                    (!t.component && Wi(t.tag, t.attrsMap.type, r))
                      ? Mr(t, r, i, u[e], c)
                      : Lr(t, r, i, u[e], c);
                else if (Xi.test(r))
                  (r = r.replace(Xi, "")),
      ...
      function Ja(t, e, n, r) {
        return (t.ifProcessed = !0), Ga(t.ifConditions.slice(), e, n, r);
      }
      function Ga(t, e, n, r) {
        if (!t.length) return r || "_e()";
        var o = t.shift();
        return o.exp
          ? "(" + o.exp + ")?" + i(o.block) + ":" + Ga(t, e, n, r)
          : "" + i(o.block);
        function i(t) {
      ...
      function Ya(t, e) {
        ...
        if (t.for && !t.forProcessed) return Wa(t, e, Ya);
      ...
      var Jc = (function (t) {
        function e(e, n) {
          t.call(this, e, n), (this._startLocation = Gc(this.base));
        }
        return (
          t && (e.__proto__ = t),
          ...
          (e.prototype.ensureURL = function (t) {
            if (Gc(this.base) !== this.current.fullPath) {
        ...
        nu = function (t) {
          ...
          switch (
            ...
            case "history":
              ...
              break;
            case "hash":
              this.history = new Wc(this, t.base, this.fallback);
              break;
            case "abstract":
      ...
      (nu.prototype.match = function (t, e, n) {
        ...
        (nu.prototype.init = function (t) {
          ...
          if (
            ...
            this.app = t;
            var n = this.history;
            if (n instanceof Jc || n instanceof Wc) {
              var r = function (t) {
                n.setupListeners(),
                  (function (t) {
                    var r = n.current,
      ...
      ms.use(iu);
      const Mu = {
        "contracts/ForeToken.sol:ForeToken": {
          source: "contracts/ForeToken.sol",
          name: "ForeToken",
          constructor: {
            inputs: [],
